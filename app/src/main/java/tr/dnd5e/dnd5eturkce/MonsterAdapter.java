...
public class MonsterAdapter extends ArrayAdapter<Monster> {
    ...
    MonsterAdapter(Activity context, List<Monster> monsterList) {
        super(context, R.layout.row_monsters, monsterList);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (rowView == null) {
            ...
            rowView = inflater.inflate(R.layout.row_monsters, null);
        }
...
//                rowOnClick(getItem(position));
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        MyViewHolder(View itemView) {
            super(itemView);
            titleTextView = itemView.findViewById(R.id.monsters_row_title);
            descriptionTextView = itemView.findViewById(R.id.monsters_row_description);
        }
    }
