...
public class ItemAdapter extends ArrayAdapter<Item> {
    ...
    ItemAdapter(Activity context, List<Item> itemList) {
        super(context, R.layout.row_items, itemList);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (rowView == null) {
            ...
            rowView = inflater.inflate(R.layout.row_items, null);
        }
...
//                rowOnClick(getItem(position));
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        MyViewHolder(View itemView) {
            super(itemView);
            titleTextView = itemView.findViewById(R.id.items_row_title);
            descriptionTextView = itemView.findViewById(R.id.items_row_description);
        }
    }
