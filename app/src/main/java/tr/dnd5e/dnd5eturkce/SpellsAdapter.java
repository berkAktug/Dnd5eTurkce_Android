...
public class SpellsAdapter extends ArrayAdapter<Spells> {

    private Activity context;

    SpellsAdapter(Activity context, List<Spells> spellsList) {
        super(context, R.layout.row_spells, spellsList);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (rowView == null) {
            ...
            rowView = inflater.inflate(R.layout.row_spells, null);
        }
...
//                rowOnClick(getItem(position));
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        MyViewHolder(View itemView) {
            super(itemView);
            titleTextView = itemView.findViewById(R.id.spells_row_title);
            descriptionTextView = itemView.findViewById(R.id.spells_row_description);
        }
    }
